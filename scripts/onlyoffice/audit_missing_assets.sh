...
#   hdc shell "> /data/app/el2/100/base/app.hackeris.winehua/haps/entry/files/web_console.txt"
#
...
CONSOLE=/data/app/el2/100/base/app.hackeris.winehua/haps/entry/files/web_console.txt
